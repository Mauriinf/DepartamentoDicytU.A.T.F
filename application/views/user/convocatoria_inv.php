				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="<?= base_url('user_controller/');?>">Inicio </a>  <span class="lnr lnr-arrow-right"></span> <a href="<?= base_url('user_controller/convocatorias_investigacion');?>"> Convocatorias de Investigación</a></p>
						</div>	
					</div>
				</div>
			</section>
					...
					<div class="row">
						...
						<br>							
							...
							if ($investigacion==false) {
								echo '';
							}else {$no=1; foreach ($investigacion as $inves) { ?>
							<tr>
