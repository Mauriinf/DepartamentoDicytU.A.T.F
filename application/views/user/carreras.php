				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
							<?php echo $nomcar->nombre_carrera;?>
						  </h1>	
							<p class="text-white link-nav"><a href="<?= base_url('user_controller/');?>">Inicio </a>  <span class="lnr lnr-arrow-right"></span>  <?php echo $nomcar->nombre_carrera;?></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8 posts-list">
							...
							if ($carrera==false) {
								echo '';
								}else { $no=1; foreach ($carrera as $facp) { ?>
						<tr>
						...
						<div class="col-lg-4 sidebar-widgets">
							<div class="widget-wrap">
							  ...
							  <div class="single-sidebar-widget post-category-widget">
							    <h4 class="category-title"><?php echo $nomcar->nombref;?></h4>
									<ul class="cat-list">
									<?php foreach ($nombrescarrera as $carreras) {?>
