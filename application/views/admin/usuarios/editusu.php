    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <form autocomplete="off" action="<?php echo base_url('administrador/usuarios_modal/editar');?>" id="from_usuario" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                $datos=base_url('uploads/user_img/'.$usuario->imagen);
                    ...
                    <div class="controls">
                      ...
                      <?php foreach ($estra as $rol):?>
                        <?php if($rol->id == $usuario->rol_id): ?>
                ...
                <select name="facultadp" id="facultadp" class="form-control">
                  ...
                  <?php foreach ($estrap as $facu):?>
                     <?php if($facu->id_facultad == $usuario->id_facultad): ?>
                ...
                <select name="carrerap" id="carrerap" class="form-control">                  
                  ...
                  <?php foreach ($carrera as $carrera):?>
                     <?php if($carrera->id_carrera == $usuario->id_carrera): ?>
