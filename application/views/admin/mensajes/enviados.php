      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> Buzon de Salida</h3>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
             <form autocomplete="off" name="holas" action="<?php echo base_url('mensajes/mensajes_modal/delete');?>" method="POST">
            <div class="box-body no-padding">
                ...
                <table class="table table-hover table-striped" id="mensajes" class="display">
                 <thead>
                  <tr>
                    ...
                    <td class="mailbox-date"><b>Fecha</b></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="<?php echo base_url();?>mensajes/mensajes_modal/verI/<?php echo $dato->id_mensaje;?>"><?php echo $dato->usuario;?></a></td>
                    ...
                    <td class="mailbox-date"><?php echo $dato->fecha;?></td>
                    <td class="mailbox-name">
                    <?php if($dato->leido==1){echo '<button type="button" class="btn btn-block btn-success btn-xs">Leido</button>';}
                    else{echo '<button type="button" class="btn btn-block btn-danger btn-xs">No Leido</button>';}?>
