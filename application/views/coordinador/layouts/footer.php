  ...
  $(document).ready(function () {
      ...
      eventLimit: true, // allow "more" link when too many events
          ...
          eventClick: function(event, jsEvent, view) {
              ...
              if (event.url) {
                window.location=(event.url+event.id);
                return false;
              }
    ...
    $('#facultadp1').change(function(){
      var facultad_id = $('#facultadp1').val();
      if (facultad_id != '')
      {
        $.ajax({
          url:'<?php echo base_url();?>proyectos/proyectos_modal/combocarrera',
    ...
    $(".btn-view-proyecto").on("click",function(){
     ...
     $(".btn-view-portada").on("click",function(){
      var portada=$(this).val();
      var infoportada= portada.split('*');
      html='<p><strong>Imagen: </strong><img src="'+infoportada[1]+'" width="100px" height="100px"></p>'
      html+='<p><strong>Descripcion: </strong> '+infoportada[2]+'</p>';

      $('#verModalPor .modal-body').html(html);
    });
     ...
     $(".btn-view-convo").on("click",function(){
      ...
      html+='<p><strong>Fecha de Inicio: </strong> '+infoconvocatoria[4]+'</p>'
      html+='<p><strong>Fecha Final: </strong> '+infoconvocatoria[5]+'</p>'
      html+='<p><strong>Tipo de Convocatoria: </strong> '+infoconvocatoria[6]+'</p>'
      html+='<p><strong>Archivo: </strong>'+infoconvocatoria[7]+'</p>';
        ...
        buttons: [
            {
                ...
                exportOptions: {
                    columns: [ 0, 2, 3, 4, 5, 6, 7, 8, 1, 9]
                }
            },
            {
                extend: 'pdfHtml5',
                orientation: 'landscape',
                pageSize: 'LETTER',//LETTER(carta), legal(oficio), A4
                download:'open',
                title: "TRABAJOS DE INVESTIGACION DICYT ",
                exportOptions: {
                    columns: [ 0, 2, 3, 4, 5, 6, 7, 8, 1, 9]
