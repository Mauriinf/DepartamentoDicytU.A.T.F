          ...
          <div class="row">
            <div class="col-md-12">
              <form autocomplete="off" action="<?php echo base_url('portada/portada_modal/editar');?>" id="form_portada" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="controls">
                <input type="text" name="titulo" id="desc" value="<?php echo $portadas->titulo;?>" class="form-control input-sm">
                </div></div>
                <div class="control-group">
                <label class="control-label">Descripcion</label>
                <div class="controls">
                <input type="text" name="desc" id="desc" value="<?php echo $portadas->descripcion;?>" class="form-control input-sm">
                </div></div>   
                <label>Imagen</label>
