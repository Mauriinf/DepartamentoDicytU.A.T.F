      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form autocomplete="off" method="post" action="<?php echo base_url();?>mensajes/mensajes_modal/guardar"  accept-charset="utf-8"  enctype="multipart/form-data">
            <div class="box-body">
                ...
                <select class="form-control" name="destinatario">
                  ...
                  <?php
                    foreach ($destinatarios as $desti) {
                      $nombrerol='';
                      if($desti->rol_id==1){
                        $nombrerol='DIRECTOR DICYT';
                      }
                      if($desti->rol_id==2){
                        $nombrerol='DIRECTOR INSTITUTO DE INVESTIGACIÓN';
                      }
                      if($desti->rol_id==4){
                        $nombrerol='COORDINADOR DICYT';
                      }
                      if($desti->rol_id==3){
                        $nombrerol='USUARIO';
                      }
                      echo '<option value="'.$desti->id_usuario.'">'.$desti->email.' ('.$nombrerol.')</option>';
                    }
                  ?>
                </select>
              </div>
              ...
              <div class="form-group">
                    <textarea id="editor" class="form-control" style="height: 300px" name="mensaje">
