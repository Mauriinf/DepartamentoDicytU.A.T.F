  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="<?php echo base_url();?>panel/admin"><i class="fa fa-dashboard"></i> <span> Inicio</span></a></li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href=""><i class="fa fa-circle-o text-aqua"></i> Sociedades Cienctificas</a></li>
          </ul>
        </li>
        ...
        <li><a href="<?php echo base_url();?>avances/avances_modal/catego"><i class="glyphicon glyphicon-scale"></i> <span> Avances</span></a></li>
        <li>
